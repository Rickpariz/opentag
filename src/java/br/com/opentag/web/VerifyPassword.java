 ...
 */
public class VerifyPassword implements Run{
    ...
    public String run(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            String passwordDB = dao.searchPassword(id);
            if (passwordDB == null || !BCrypt.checkpw(password, passwordDB)) {
                jsonResponse.setStatus(false);
                jsonResponse.setMessage("Senha invalida !");
            } else {
                jsonResponse.setStatus(true);
                jsonResponse.setMessage(" Senha Correta ");
            }
